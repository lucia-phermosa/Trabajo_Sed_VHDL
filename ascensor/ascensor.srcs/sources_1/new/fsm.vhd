...
architecture Behavioral of fsm is 
    ...
    -- Señales para los estados de la fsm
...
begin
    ...
    begin
        ...
        case curr_state is
            ...
            when STANDBY => 
               chip_enable <= '0';
                if (piso_deseado /= "1111" and piso_deseado /= piso_actual) then
                    nxt_state <= CLOSING;
                    nxt_btn_memo <= piso_deseado;
                end if;
            when CLOSING =>
              chip_enable <= '1';
              wait_value <= 250000000;
